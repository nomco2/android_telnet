...
public class CustomAdapter extends BaseAdapter {
	...
	private ArrayList<database.data.InfoClass> infoList;
	private ViewHolder viewHolder;
	
	public CustomAdapter(Context c , ArrayList<database.data.InfoClass> array){
	...
	public void setArrayList(ArrayList<database.data.InfoClass> arrays){
		this.infoList = arrays;
	}
	
	public ArrayList<database.data.InfoClass> getArrayList(){
		return infoList;
	}
